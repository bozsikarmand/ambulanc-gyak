...
-- Dumping data for table bozsika_ambulanc.jog: ~4 rows (approximately)
...
-- Dumping data for table bozsika_ambulanc.kozterulet: ~36 rows (approximately)
...
-- Dumping structure for table bozsika_ambulanc.munkamenet
CREATE TABLE IF NOT EXISTS `munkamenet` (
  `MunkamenetID` int(11) NOT NULL AUTO_INCREMENT,
  `MunkamenetKezdete` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Dumping data for table bozsika_ambulanc.munkamenet: ~0 rows (approximately)
...
-- Dumping structure for table bozsika_ambulanc.szemelymunkamenet
...
-- Dumping data for table bozsika_ambulanc.szemelymunkamenet: ~0 rows (approximately)
