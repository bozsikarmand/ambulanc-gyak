...
<head>
    ...
    <meta charset="UTF-8">
    <title>Szállitások listája</title>
    ...
    <table class="table" data-toggle="table" id="datatable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="/protected/dashboard/functions/admin/modify/transport.php?id=<? echo $row['ID'] ?>" class="btn btn-warning">
                        <i class="fas fa-edit"></i> Módositás
                    </a>
                    <a href="/protected/dashboard/functions/admin/delete/transport.php?id=<? echo $row['ID'] ?>" class="btn btn-danger">
