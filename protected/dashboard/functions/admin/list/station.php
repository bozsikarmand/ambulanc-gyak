...
require_once ($_SERVER['DOCUMENT_ROOT'] . "/core/action/list/station.php");
    ...
    <table class="table" data-toggle="table" id="datatable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="/protected/dashboard/functions/admin/modify/station.php?id=<? echo $row['ID'] ?>" class="btn btn-warning">
                        <i class="fas fa-edit"></i> Módositás
                    </a>
                    <a href="/protected/dashboard/functions/admin/delete/station.php?id=<? echo $row['ID'] ?>" class="btn btn-danger">
