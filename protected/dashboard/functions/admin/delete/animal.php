...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
    ...
    <div class="container-fullwidth" style="margin-top:100px">
            ...
            <div class="form-label-group">
                <a href="/protected/dashboard/functions/admin/delete/animal.php?id=<?php echo $row['ID']; ?>&confirm=yes" class="btn btn-lg btn-primary btn-block" name="button-delete-animal" type="submit">
                    Igen
                </a>
                <a href="/protected/dashboard/functions/admin/delete/animal.php?id=<?php echo $row['ID']; ?>&confirm=no" class="btn btn-lg btn-secondary btn-block" name="button-back-animal">
                    Nem
                </a>
            </div>
    </div>
