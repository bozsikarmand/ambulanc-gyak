...
<head>
    ...
    <meta charset="UTF-8">
    <title>Felhasználók törlése</title>
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
    ...
    <div class="container-fullwidth" style="margin-top:100px">
            <p>Szeretnéd törölni a megadott azonositójú felhasználót?</p>
            <div class="form-label-group">
                <a href="/core/action/delete/user.php?id=<?php echo $_GET['id']; ?>&confirm=yes" class="btn btn-lg btn-primary btn-block" name="button-delete-animal" type="submit">
                    Igen
                </a>
                <a href="/core/action/delete/user.php?id=<?php echo $_GET['id']; ?>&confirm=no" class="btn btn-lg btn-secondary btn-block" name="button-back-animal">
                    Nem
                </a>
            </div>
    </div>
