...
<form class="form-signin">
    ...
    <div class="row">
        ...
        <button class="btn btn-lg btn-primary btn-block" name="button-logout" type="submit">
            <i class="fas fa-sign-out-alt"></i> Kijelentkezés
        </button>
        <button class="btn btn-lg btn-secondary btn-block" name="button-profile-settings" type="submit">
            <i class="fas fa-sign-in-alt"></i> Profilom
        </button>
