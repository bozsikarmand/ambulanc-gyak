...
<form class="form-signin" action="core/authentication/register.php" method="post">
    ...
    <div class="custom-control custom-checkbox mb-3">
        ...
        <label class="custom-control-label" for="customCheckBoxTOS"> 
            Elfogadom a <a href="core/docs/terms-of-service.html" target="_blank">felhasználási feltételeket</a>
        </label>
    </div>
    <div class="custom-control custom-checkbox mb-3">
        <input type="checkbox" class="custom-control-input" id="customCheckBoxPP" name="agree-pp" value="Yes" required="required">
        <label class="custom-control-label" for="customCheckBoxPP"> 
            Elfogadom az <a href="core/docs/privacy-policy.html" target="_blank">adatvédelmi nyilatkozatot</a>
        </label>
    </div>
